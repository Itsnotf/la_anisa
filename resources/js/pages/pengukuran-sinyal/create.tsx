...
import { KekuatanSinyal, Provider, Wilayah } from '@/types';
...
export default function CreatePengukuranSinyal({ wilayahs, providers, kekuatanSinyals }: Props) {
    ...
    const onSubmit = (data: z.infer<typeof formSchema>) => {
        ...
        router.post(`/pengukuranSinyal`, formattedData as any);
    };
    ...
    return (
        ...
        >
            <Head title="Create PengukuranSinyal" />
            <div className="m-4 flex max-h-fit max-w-full flex-1 flex-col gap-4 rounded-xl border p-4">
                <h1 className="text-xl font-semibold">Create PengukuranSinyal</h1>
                <Form {...form}>
